    ...
    <?php
        if ( isset($_SESSION["id"])) {
          switch($_SESSION["userrole"]) {
            ...
            case 'root': 
              echo '<li class="nav-item">
                      <a class="nav-link" href="./index.php?content=root_home">RootHome<span class="sr-only">(current)</span></a>
                    </li>';
              echo '<li class="nav-item">
                    <a class="nav-link" href="./index.php?content=influencer_home">InfluencerHome<span class="sr-only">(current)</span></a>
                  </li>';
              echo '<li class="nav-item">
            ...
            case 'customer':
              ...
              echo '<li class="nav-item">
                    <a class="nav-link" href="./index.php?content=inspection_home">InspectionHome<span class="sr-only">(current)</span></a>
                  </li>';
            break;
            case 'moderator':
              echo '<li class="nav-item">
                      <a class="nav-link" href="./index.php?content=moderator_home">ModeratorHome<span class="sr-only">(current)</span></a>
                    </li>';
              echo '<li class="nav-item">
                    <a class="nav-link" href="./index.php?content=influencer_home">InfluencerHome<span class="sr-only">(current)</span></a>
                  </li>';
      ...
      <li class="nav-item">
        <a class="nav-link" href="./index.php?content=infoform">info</a>
      </li>
